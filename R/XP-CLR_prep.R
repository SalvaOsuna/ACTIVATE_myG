...
ldp_samples <- sample_ids[grepl("_AGL$", sample_ids)] # Assuming LDP lines use _ALG or similar
...
# --- 2. Calculate Allele Frequencies natively (Extremely Fast) ---
...
cat("Done! Exact math emulation complete. Plot and data saved in Results/.\n")
